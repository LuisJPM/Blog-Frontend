...
import { usePublicacionesID } from "../shared/hooks/usePublicationsID.jsx";
...
export const PublicacionDetalle = () => {
  const { id } = useParams();
  const { publicacion, comentarios, cargando, error, setComentarios } =
    usePublicacionesID(id);
  ...
  if (!publicacion)
    return (
      <p style={{ textAlign: "center" }}>No se encontró la publicación.</p>
    );
    ...
    <div className="publicacion-detalle">
      <div className="publicacion-card detalle-publicacion-card">
        ...
        <div className="detalle-info">
          <p>
            <strong>Curso:</strong> {publicacion.cursoPublicacion}
          </p>
          <p>
            <strong>Fecha:</strong>{" "}
        ...
        <form className="comentario-form" onSubmit={handleSubmit}>
          <label>
            ...
            <input
              ...
              onChange={(e) =>
                setComentario({ ...comentario, usuario: e.target.value })
              }
              required
            />
          </label>
          <label>
            ...
            <input
              ...
              onChange={(e) =>
                setComentario({
                  ...comentario,
                  contenidoComentario: e.target.value,
                })
              }
              required
            />
